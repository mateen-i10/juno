...
import CatalogModelActions from "./components/CatalogModelActions";
  ...
  const tableActions = (currentRow: GridRenderCellParams) => {
    return (
      <>
        ...
        <CatalogModelActions row={currentRow} />
    ...
    <>
      <Grid container spacing={12}>
        <Grid item xs={12} md={12} style={{marginLeft: '10px'}}>
          <h2 style={{color: 'rgb(122 121 127)'}} title={'List'}>Catalog Model List</h2>
        </Grid>
      </Grid>
